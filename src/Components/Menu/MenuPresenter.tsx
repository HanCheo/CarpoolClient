...
const ToggleDriving = styled.button<IToggleProps>`
  ...
  background-color: ${props =>
    props.isDriving ? props.theme.greenColor : props.theme.yellowColor};
  width: 100%;
  color: white;
  font-size: 18px;
  border: 0;
          ...
          <Grid>
            <Link to={"/edit-account"}>
              <Image
                src={
                  user.profilePhoto ||
                  "https://icon-library.net/images/user-icon-image/user-icon-image-19.jpg"
                }
              />
            </Link>
            <Text>
